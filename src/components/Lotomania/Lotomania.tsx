...
export function Lotomania() {
  const { data }: SearchLoteriaResult = SearchLoterias("lotomania");
  return (
    <div className="text-center justify-center top-52 max-h-screen text-black bg-zinc-100 flex w-full  p-6 rounded-t-[3rem]">
